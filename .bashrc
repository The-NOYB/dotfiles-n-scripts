...
alias study_time='time=0 && while true; do time=$(($time+1));sleep 60 && notify-send "You can do it! ($time mins)";done'
alias nohist='set +o history'
alias earphones='bluetoothctl power on && bluetoothctl connect C5:5C:08:04:11:D0'
